    ...
    <div className="about-container">
      ...
      <div className="about-info">
        <p>
          ...
          <br />I am always eager to learn new tools and adapt to new
          environments. Staying on top of the latest trends of development and
          design to ensure I can deliver the best possible results for your
          company as well as personal projects.
        </p>
      </div>
    </div>
  );
